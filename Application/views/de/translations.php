...
return [
    ...
    'SHOP_MODULE_GROUP_d3totp_logging'                => 'Logeinstellungen',
    'SHOP_MODULE_D3_TOTP_setting_logLevel'            => 'Loglevel',
    'SHOP_MODULE_D3_TOTP_setting_logLevel_debug'      => 'debug',
    'SHOP_MODULE_D3_TOTP_setting_logLevel_info'       => 'info',
    'SHOP_MODULE_D3_TOTP_setting_logLevel_notice'     => 'notice',
    'SHOP_MODULE_D3_TOTP_setting_logLevel_warning'    => 'warning',
    'SHOP_MODULE_D3_TOTP_setting_logLevel_error'      => 'error',
    'SHOP_MODULE_D3_TOTP_setting_logLevel_critical'   => 'critical',
    'SHOP_MODULE_D3_TOTP_setting_logLevel_alert'      => 'alert',
    'SHOP_MODULE_D3_TOTP_setting_logLevel_emergency'  => 'emergency',
    'SHOP_MODULE_D3_TOTP_setting_keptlogfiles'        => 'Anzahl zu speichernder täglicher Logfiles',
    'HELP_SHOP_MODULE_D3_TOTP_setting_keptlogfiles'   => 'Es wird für jeden Tag eine neue Datei angelegt. Ältere Dateien werden automatisch gelöscht.',
    'SHOP_MODULE_D3_TOTP_setting_logOnErrorsOnly'     => 'Logeinträge werden nur im Fehlerfall geschrieben',
